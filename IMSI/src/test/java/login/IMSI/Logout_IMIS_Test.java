...
public class Logout_IMIS_Test {
	...
	//	driver = new ChromeDriver();
		reports = ExtentManager.GetExtent("IMIS LOGOUT");
		test = reports.createTest("IMIS Logout: ");
	...
	public void logoutToProj(String username ,String Password) throws InterruptedException
	{
		...
		WebElement ele= wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//button[@id='continue_login_btn']"))));
		ele.click();
	...
	//	Thread.sleep(3000);
		...
		driver.quit();
	//	Thread.sleep(2000);
		test.info("User: "+username +"Logged out Succesfully");
